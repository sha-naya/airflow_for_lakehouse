...
with DAG(
    ...
    download_odbc_driver = BashOperator(task_id='download_odbc18_driver', bash_command="curl -O https://download.microsoft.com/download/1/f/f/1fffb537-26ab-4947-a46a-7a45c27f6f77/msodbcsql18_18.2.1.1-1_amd64.apk")

    install_odbc_driver = BashOperator(task_id='install_odbc18_driver', bash_command="sudo apk add --allow-untrusted msodbcsql18_18.2.1.1-1_amd64.apk")
    ...
    send_to_azure = PythonOperator(
        task_id = 'send_to_azure',
        python_callable = upload_to_azure_sql
    )

    download_odbc_driver >> install_odbc_driver >> get_data >> send_to_azure
